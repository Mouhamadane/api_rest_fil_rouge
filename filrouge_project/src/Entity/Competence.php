...
class Competence
{
     ...
     * @Groups({"briefbrouillons:read","competence:read","competence:stat", "groupecompetence:read", "groupecompetence:write", "referentiel:read:all", "promo:referentiel:read"})
     */
    private $id;
     ...
     * @Groups({"briefbrouillons:read","groupecompetence:read","competence:stat", "groupecompetence:write", "competence:read", "competence:write", "referentiel:read:all", "promo:referentiel:read"})
     */
    private $libelle;
