 ...
 */
final class Version20200805103528 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE groupe_competence (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, descriptif LONGTEXT NOT NULL, INDEX IDX_2C3959A3642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE statut statut TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
