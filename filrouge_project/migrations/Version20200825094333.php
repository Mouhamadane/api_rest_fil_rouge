 ...
 */
final class Version20200825094333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ressource ADD piece_jointe LONGBLOB NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ressource DROP piece_jointe');
    }
}
